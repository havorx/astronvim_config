...
return {
  ...
  }, ]]
  {
    ...
    keys = {
      { prefix, desc = "Node package info" },
      { prefix .. "s", "<cmd>lua require('package-info').show()<cr>", desc = "Display Latest Package Version" },
      { prefix .. "p", "<cmd>lua require('package-info').change_version()<cr>", desc = "Install Different Version" },
      { prefix .. "d", "<cmd>lua require('package-info').delete()<cr>", desc = "Delete Dependency" },
    },
    opts = {},
